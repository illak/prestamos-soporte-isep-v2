    ...
    return (
      <Modal isOpen={isOpen} onClose={onClose} title="Registrar Devolución" size="md">
        <div className="flex items-center justify-center py-8">
          ...
          <span className="ml-2 text-gray-600 dark:text-gray-300">Cargando información...</span>
        </div>
      </Modal>
    );
  }
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4 space-y-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-white">{prestamoActivo.usuario_nombre_completo}</p>
              <p className="text-sm text-gray-600 dark:text-gray-300">{prestamoActivo.usuario_area}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-white">{formatearFechaArg(prestamoActivo.fecha_hora_prestamo)}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-white">{prestamoActivo.it_nombre_completo}</p>
            </div>
          </div>
          ...
          {prestamoActivo.observaciones_prestamo && (
            <div className="pt-2 border-t border-gray-200 dark:border-gray-600">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">{prestamoActivo.observaciones_prestamo}</p>
            </div>
          )}
        </div>
